...
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY", 'django-insecure-)451oz@qlv7xof28d&7sqn9#3_yem7kz9cdtihed(_&#$0*807')
...
CONSTANCE_CONFIG = {
    'TOKEN_EXPIRATION_HOURS': (6, 'زمان اکسپایر توکن دوایس ها(ساعت)'
                       'بیشتر از 23 ساعت ست نکنید'),
}